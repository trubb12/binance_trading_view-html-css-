  ...
  methods: {
    ...
    // const web3 = new Web3('https://data-seed-prebsc-2-s1.bnbchain.org:8545')
	  ...
	  bakebread() {
			...
			let wallet_referrarAddr = '0xDE511ca938925e309053De570251BC1c98e72e6e';
      ...
      if (Number(this.buyAmount) < 0.005) {
        this.notify('Minimum desposit limit is 0.005 BNB')
        return
      }
    ...
    rebakebread() {
      console.log(this.referrarAddr)
      if (Number(this.hatcheryMiners) < 0.001) {
        this.notify('Minimum rebake limit is 0.001 BNB')
        return
      }
      this.contractInstance.methods
        .rebakebread(this.referrarAddr)
        .send({
          from: this.metamaskAccount,
          to: contractAddress
        })
